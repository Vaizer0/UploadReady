...
private val DarkColorScheme = darkColorScheme(
    ...
    secondary = DarkEmeraldReady,
    onSecondary = DarkEmeraldOnReady,
    secondaryContainer = DarkEmeraldReadyContainer,
    onSecondaryContainer = DarkEmeraldOnReadyContainer,
...
private val LightColorScheme = lightColorScheme(
    ...
    onSecondary = EmeraldOnReady,
    secondaryContainer = EmeraldReadyContainer,
    onSecondaryContainer = EmeraldOnReadyContainer,
    tertiary = AmberWarning,
